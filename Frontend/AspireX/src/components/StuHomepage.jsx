...
const StuHomepage = () => {
  return (
    <>
              ...
              <div id="wel-search">
                {/* ✅ Search bar without Google mic option */}
          ...
          <div className="flip-card-inner">
            <div className="flip-card-front">
              ...
              <div className="name">Rittul Raj</div>
              <div className="profession">Data Science Engineer</div>
            </div>
        ...
        <div className="flip-card">
          <div className="flip-card-inner">
            <div className="flip-card-front">
              ...
              <div className="name">Abhinav Gupta</div>
              <div className="profession">Machine Learning Engineer</div>
            </div>
            <div className="flip-card-back">
              <div className="Description">
                <p className="description">
        ...
        <div className="flip-card">
          <div className="flip-card-inner">
            <div className="flip-card-front">
              ...
              <div className="name">Harsh Chauhan</div>
              <div className="profession">Data Science Engineer</div>
            </div>
            <div className="flip-card-back">
              <div className="Description">
