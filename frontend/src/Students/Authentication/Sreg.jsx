...
function Sreg() {
 ...
 const user = {
  ...
  try {
    const response = await axios.post('http://127.0.0.1:8000/api/student/register/', user, {
    ...
    <>
      ...
      <div id="Middlesignup">
        <div className="headingsignup">
          <h2 id="reg-Perfect">
            {" "}
            <Typewriter2 text="Want the Perfect Guidance ?" speed={100} />
          </h2>
          <div className="wantimg">
            <img src="/RegisterImg.svg" alt="" id="img1" />
          </div>
        </div>
