...
function Login() {
  ...
  const handleGoogleSignIn = async (response) => {
    ...
    try {
      ...
      localStorage.setItem('Mentortoken', result.data.token);
      ...
      <StyledWrapper>
        <div className="container">
          ...
          <form className="form" onSubmit={handleSubmit}>
            ...
            <input placeholder="Password" name="password" type="password" className="input" onChange={handleChange} required autoComplete="current-password" />
